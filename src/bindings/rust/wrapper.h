...
nixl_capi_status_t nixl_capi_create_params(nixl_capi_params_t* params);
nixl_capi_status_t nixl_capi_params_add(nixl_capi_params_t params, const char* key, const char* value);
