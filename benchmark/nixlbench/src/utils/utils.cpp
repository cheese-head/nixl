...
DEFINE_string(backend, XFERBENCH_BACKEND_UCX, "Name of communication backend [UCX, UCX_MO, GDS, GDS_MT, POSIX, GPUNETIO] \
...
int xferBenchConfig::gds_mt_thread_count = 0;
